<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Ingles1.aspx.vb" Inherits="_Default" %>
            ...
            <div class="col-lg-12 row" style="padding:2% 0% 0% 4%">
                ...
                <div class="col-lg-12 content_Pregunta">
                        <asp:Panel ID="Panel1" runat="server" >
                           <label>
                               <span>was/heavity/it/raining</span>
                           </label> 
                            <br />
                            <asp:TextBox ID="txt1nivel1" runat="server" class="form-control"></asp:TextBox>
                        </asp:Panel>
                </div>
                 <div class="col-lg-12 content_Pregunta">
                    <asp:Panel ID="Panel2" runat="server" >
                        <label>
                            <span> driver/he/good/a/is</span>
                        </label>
                        <br />
                        <asp:TextBox ID="txt2nivel1" runat="server" class="form-control"></asp:TextBox>
                    </asp:Panel>
                 </div>
